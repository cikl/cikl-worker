...
describe Cikl::Worker::DNS::JobBuilder do
  it_should_behave_like "a job builder" do
    let(:payload) { '{"address":{"fqdn":"live.com"},"source":"alexa.com","alternativeid_restriction":"public","restriction":"need-to-know","reporttime":"2014-03-27T15:59:01.000Z","alternativeid":"http://www.alexa.com/siteinfo/<fqdn>","confidence":95,"group":"everyone","assessment":"whitelist","description":"alexa #<rank>","@version":"1","@timestamp":"2014-03-27T15:59:01.000Z","type":"event"}' }
  end
  ...
  context "when parsing a payload is missing the 'address' component" do
    it_should_behave_like "a job builder encountering a bad payload" do
      let(:payload) { '{"source":"alexa.com","alternativeid_restriction":"public","restriction":"need-to-know","reporttime":"2014-03-27T15:59:01.000Z","alternativeid":"http://www.alexa.com/siteinfo/<fqdn>","confidence":95,"group":"everyone","assessment":"whitelist","description":"alexa #<rank>","@version":"1","@timestamp":"2014-03-27T15:59:01.000Z","type":"event"}' }
    end
  end
